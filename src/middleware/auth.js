...
authRouter.post("/login", (req, res) => {
  ...
  if (email === ADMIN_EMAIL && password === ADMIN_PASSWORD) {
    // 🔥 CORREGIDO: Ahora firma usando el .env de manera consistente
...
// 🔐 Middleware para verificar Sesión (Token JWT)
export const verificarToken = (req, res, next) => {
  ...
  try {
    // 🔥 Valida usando exactamente la misma variable del .env
...
// 📝 Middleware para validar esquemas de Joi en el Body
